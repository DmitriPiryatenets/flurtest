...
/**
 * The interface that provides basic operations for interacting with the logic
 * objects. This is a generic interface that means that any logic class can be
 * used, but it is mandatory to create a sub-class for each.
 * 
 * @author ag
 * 
 * @param <E>
 *            The logic class that represents the data from the base.
 */
public interface ElementDAO<E> {
	...
	/**
	 * Removes all elements from the base.
	 */
